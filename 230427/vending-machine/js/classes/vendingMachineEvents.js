class VendingMachineEvents{
    constructor(){
        ...
        this.btnsCola = vMachine.querySelectorAll('.btn-cola');
    ...
    bindEvent(){
         ...
         * 1) 소지금 === 소지금 - 입금액
         * 2) 잔액 === 기존 잔액 + 입금액
         * 3) 입금액의 소지금보다 많으면 경고장 출력
         * 4) 입금액의 정상적으로 입금되면 입금창은 초기화 되야 한다.
         */
         ...
         * 3) 아이템이 장바구니에 들어갑니다.
         * 4) 아이템이 count가 -1이 됩니다. 아이템이 카운트가 0이 되면 품절 표시를 합니다.
         */
