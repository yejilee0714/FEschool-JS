...
// flag로 global을 주어서 전체 변경(m-다중라인, i-대소문자구분 X)
'paullab CEO leehojun hello CEO'.replace(/CEO/g, 'CTO') // 'paullab CTO leehojun hello CEO'
// 패턴을 찾아 Array로 반환
...
'!a!abc!abcd'.split('!') // 앞에 공백
'!!!'.split('!') // 4개
'!a!a!a'.split('!') // 4개 // 앞에 공백
'a!a!a!'.split('!') // 4개 // 뒤에 공백
...
"aAb182cC34oOp".match(/\d/g)
"aAb182cC34oOp".match(/\d+/g).reduce((a, b) => parseInt(a) + parseInt(b), 0)
"aAb182c111C34oO123p".match(/\d+/g)
...
'87a99b00fww89e'.match(/([0-9][0-9])([a-zA-Z])/g) // 숫자 그룹과 문자 그룹으로 나눈다.
